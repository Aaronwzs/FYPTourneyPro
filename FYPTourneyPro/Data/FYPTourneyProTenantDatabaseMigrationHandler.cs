...
public class FYPTourneyProTenantDatabaseMigrationHandler :
    ...
    ITransientDependency
{
    ...
    private readonly ILogger<FYPTourneyProTenantDatabaseMigrationHandler> _logger;

    public FYPTourneyProTenantDatabaseMigrationHandler(
        FYPTourneyProDbSchemaMigrator dbSchemaMigrator,
        ICurrentTenant currentTenant,
        IUnitOfWorkManager unitOfWorkManager,
        IDataSeeder dataSeeder,
        ITenantStore tenantStore,
        ILogger<FYPTourneyProTenantDatabaseMigrationHandler> logger)
    {
