...
namespace FYPTourneyPro.Pages.Account
{
    public class RegisterModel : AccountPageModel
    {
        ...
        public IEnumerable<string> Nationalities => new List<string> { "Malaysian", "Non - Malaysian" };
        ...
        protected virtual async Task RegisterLocalUserAsync()
        {
            try
            {
                ...
                // UserDto with User input and custom user input
                ...
                // Register the User in the Identity table
                var identityUser = await AccountAppService.RegisterAsync(
                    new RegisterDto
                    {
                        AppName = "MVC",
                ...
                // call the createAsync in the custom user app service
                var customUserDto = await _customUserAppService.CreateAsync(userDto);
            ...
            {
                throw new Exception(GetLocalizeExceptionMessage(e));
            }
